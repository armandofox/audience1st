...
Background: 
  ...
  And the following orders have been placed:
    ...
    | 2/1/10 | Tom Foolery   | 2x SeasonSub | $20 donation | credit card |
    | 2/3/10 | Armando Fox   | 1x General   | 1x Discount  | credit card |
    | 2/5/10 | Bilbo Baggins | 1x SeasonSub | $15 donation | check       |
    | 2/8/10 | Barb Jones    |              | $18 donation | cash        |

Scenario: Transactions within date range should appear

  When I view revenue by payment type from "2010-02-01" to "2010-02-28"
  Then the "credit card" subtotals should be exactly:
    | account_code |  total |
    |         4040 |  68.00 |
    |         5050 | 146.00 |
    |         6060 |  20.00 |
