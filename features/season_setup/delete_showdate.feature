...
Scenario: delete showdate that has no tickets sold
  ...
  When I delete the showdate "2010-12-20 8:00pm"
  Then there should be no show on "2010-12-20 8:00pm"

Scenario: cannot delete showdate with tickets sold

  When I visit the show details page for "Hamlet"
  Then there should be no "Delete" button for the showdate "2010-12-22 8:00pm"
