...
ActiveRecord::Schema.define(version: 20200701003048) do
  ...
  add_index "customers_labels", ["customer_id", "label_id"], name: "index_customers_labels_on_customer_id_and_label_id", using: :btree
