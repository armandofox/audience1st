...
ActiveRecord::Schema.define(:version => 24) do
  ...
  create_table "customers", :force => true do |t|
    ...
    t.column "zip",                    :string
    t.column "day_phone",              :string
    t.column "eve_phone",              :string
    ...
    t.column "last_login",             :datetime,                                                                                                                                                                :default => '2007-04-06 15:40:20', :null => false
    t.column "e_blacklist",            :boolean,                                                                                                                                                                 :default => false
    t.column "referred_by_id",         :integer
    t.column "referred_by_other",      :string
    t.column "formal_relationship",    :enum,     :limit => [:None, :"Board Member", :"Former Board Member", :"Board President", :"Former Board President", :"Honorary Board Member", :"Emeritus Board Member"], :default => :None
    t.column "member_type",            :enum,     :limit => [:None, :Regular, :Sustaining, :Life, :"Honorary Life"],                                                                                             :default => :None
    t.column "company",                :string
    t.column "title",                  :string
    t.column "company_address_line_1", :string
    t.column "company_address_line_2", :string
    t.column "company_city",           :string
    t.column "company_state",          :string
    t.column "company_zip",            :string
    t.column "work_phone",             :string
    t.column "cell_phone",             :string
    t.column "work_fax",               :string
    t.column "company_url",            :string
    t.column "best_way_to_contact",    :string
  end
  ...
  create_table "options", :force => true do |t|
    ...
    t.column "type",        :enum,   :limit => [:Integer, :Float, :String, :email, :select]
  ...
  create_table "visits", :force => true do |t|
    ...
    t.column "thedate",                 :date,                                                                                                                             :null => false
  end
  ...
  create_table "vouchers", :force => true do |t|
    ...
    t.column "processed_by",       :integer,                :default => 2146722771,            :null => false
    t.column "expiration_date",    :datetime,               :default => '2008-12-31 00:00:00', :null => false
    t.column "valid_date",         :datetime,               :default => '2007-01-01 00:00:00', :null => false
    t.column "sold_on",            :datetime
  end
  ...
  create_table "vouchertypes", :force => true do |t|
    ...
    t.column "included_vouchers",   :text
    t.column "promo_code",          :string,   :limit => 20, :default => "",                    :null => false
    t.column "walkup_sale_allowed", :boolean,                :default => true
    t.column "valid_date",          :datetime,               :default => '2007-01-01 00:00:00', :null => false
    t.column "expiration_date",     :datetime,               :default => '2008-01-01 00:00:00', :null => false
    t.column "fulfillment_needed",  :boolean,                :default => false
    t.column "account_code",        :string,   :limit => 8
  end
