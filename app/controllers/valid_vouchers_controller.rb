class ValidVouchersController < ApplicationController
  ...
  def new
    ...
    return redirect_to(edit_show_path(@show), :alert => t('season_setup.errors.no_vouchertypes_exist', :season => view_context.humanize_season(@show.season))) unless @vouchertypes.count > 0
